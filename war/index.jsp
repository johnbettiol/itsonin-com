...
<html ng-app="itsonin">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="/css/style.css?v=20140405113614">
	...
	<script src="/lib/angular-google-maps.min.js" type="text/javascript"></script>
	<script src="/js/all.js?v=20140405113614" type="text/javascript"></script>
  </head>
