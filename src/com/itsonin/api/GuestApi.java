...
public class GuestApi {
	...
	public List<Guest> list(@PathParam("eventId") Long eventId,
		...
		return guestService.list(eventId, name, created, comment, sortField,
	...
	public List<Guest> list(@PathParam("eventId") Long eventId,
			...
			@QueryParam("offset") Integer offset,
			@QueryParam("limit") Integer limit) {
		return list(eventId, null, name, created, comment, sortField,
				sortOrder, numberOfLevels, offset, limit);
	}
	...
	public Response update(@PathParam("eventId") Long eventId,
			@PathParam("guestId") Long guestId, Guest guest) {
		guestService.update(guest);
		return Response.ok()
				.entity(new SuccessResponse("Guest updated successfully"))
				.build();
	}
